...
const ElectronicResources = ({
  ...
  const [electronicResourcesToDisplay, setElectronicResourcesToDisplay] =
    useState(
      electronicResources && electronicResources.slice(0, defaultNumResources),
    );
  ...
  const onClick = () => {
    ...
    setShowMore((prev) => {
      setElectronicResourcesToDisplay(
        prev
          ? electronicResources
          : electronicResources.slice(0, defaultNumResources),
      );
      return !prev;
    });
  };
    ...
    <Card ref={scrollToRef} isBordered padding='16px' id={id}>
      ...
      <CardContent>
        ...
        {electronicResources.length > defaultNumResources ? (
          ...
          >
            <Text isBold>
              View {showMore ? more : less} Available Online resources
              <Icon
