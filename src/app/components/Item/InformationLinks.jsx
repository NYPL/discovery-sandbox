...
const InformationLinks = ({
  isRecap,
  computedAeonUrl: aeonUrl,
  available,
  locationUrl: divisionUrl,
  dueDate,
  location,
}) => {
  if (available) {
    if (isRecap && !aeonUrl) {
      ...
      return (
        <Text className='availability-alert'>
          ...
          {!isRecap ? (
            <>
              <span> at </span>
              <Link className='division-link' href={divisionUrl}>
                {location}
              </Link>
            </>
          ) : null}
      ...
      return (
        <Text className='availability-alert'>
          ...
          <Link
            href={
              'https://www.nypl.org/locations/' + locationUrlEndpoint(location)
            }
          >
    ...
    return (
      <div className='availability-alert'>
        ...
        <span>
          {' - Please '}
          <Link href='https://www.nypl.org/about/divisions'>
            contact a librarian
          </Link>
          {' for assistance.'}
        </span>
