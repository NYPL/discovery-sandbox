  ...
  if (available) {
    if (isRecap) {
      ...
      return <Text className='availability-alert'>
        ...
        - Can be used on site. Please visit <Link href={'https://www.nypl.org/locations/' + locationUrlEndpoint(location)}>New York Public Library - {locationShort}</Link> to submit a request in person</Text>
    }
  } else {
    ...
    return <div className='availability-alert'>
      ...
      <span> - Please
        <Link href='https://www.nypl.org/about/divisions'> contact a librarian </Link>
        for assistance</span>
    </div>
  }
}
