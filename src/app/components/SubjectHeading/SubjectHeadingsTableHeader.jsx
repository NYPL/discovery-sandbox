...
const SubjectHeadingsTableHeader = (props) => {
  const { updateSort, selected, container, tableHeaderText } = props;
      ...
      {["related", "context"].includes(container) ? (
        <tr className="subjectHeadingRow">
          <td className="subjectHeadingsTableCell" colSpan="4">
            <h4 className="sideBarContentHeading">{tableHeaderText}</h4>
          </td>
        </tr>
      ) : null}
      <tr className="subjectHeadingRow">
        <th
          className={`headingColumnHeader ${
            selected === "alphabetical" ? "selectedColumn" : ""
          }`}
        >
          <SortButton handler={updateSort} type="alphabetical" />
        </th>
        <th
          className={`subjectHeadingAttribute narrower ${
            selected === "descendants" ? "selectedColumn" : ""
          }`}
        >
          <SortButton handler={updateSort} type="descendants" />
        </th>
        <th
          className={`subjectHeadingAttribute titles ${
            selected === "bibs" ? "selectedColumn" : ""
          }`}
        >
