  ...
  render() {
    return (
      ...
      >
        ...
        <h2 id="advancedSearchHeading" className="page-title">
          Advanced Search
        </h2>
        <form
        ...
        >
          <div id="fields">
            <div className="advancedSearchColumnLeft">
              <ul>
                {leftInputs.map((key) => (
                  <li key={key}>
                    <Label htmlFor={key} id={`${key}-input-label`}>
                      {labelsForFields[key]}
                    </Label>
                    <Input
                      id={key}
                ...
                <li>
                  <Label htmlFor="languageSelect" id="languageSelect-label">
                    Language
                  </Label>
                  <Select
                    id="languageSelect"
                  ...
                  <ul id="dateList">
                    {rightInputs.map((key) => (
                      <li key={key} id={`${key}-li`}>
                        <Label htmlFor={key} id={`${key}-li-label`}>
                          {labelsForFields[key]}
                        </Label>
                        <Input
                          id={key}
          ...
          <div id="advancedSearchButtons">
            <Button buttonType={ButtonTypes.Primary} type="submit">
              Submit
            </Button>
            <Button
