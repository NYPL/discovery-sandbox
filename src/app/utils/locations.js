 ...
 *
 *  Returns a "slug" identifying the relevant research center (e.g. 'lpa', 'schwarzman', 'schomburg')
 */

function locationSlugForLocation(locationEntity) {
