...
import {
  createResearchNowQuery as createResearchNowQueryV3,
  getResearchNowQueryString as getResearchNowQueryStringV3,
} from '../../app/utils/researchNowUtils.v3';
...
const drbQueryFromRequest = (req) => {
  ...
  if (useDrbV3) {
    ...
    drbCall = nyplApiClient({ apiName: 'drbb' }).then((client) =>
      client.post('', drbQuery),
    );
