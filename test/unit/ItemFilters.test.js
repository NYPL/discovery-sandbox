...
describe('ItemFilters', () => {
  ...
  describe('with valid `items`, no filters', () => {
    ...
    it('should have working checkboxes', () => {
      ...
      expect(checkbox.html()).to.equal(
        '<input id="SASB M1 - General Research - Room 315" class="checkbox__input" type="checkbox" aria-checked="false">',
      );
      checkbox.simulate('change');
      expect(checkbox.html()).to.equal(
        '<input id="SASB M1 - General Research - Room 315" class="checkbox__input" type="checkbox" aria-checked="true">',
      );
    });
  });
