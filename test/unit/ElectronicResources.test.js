...
const threeResource = [
  { url: 'books.com/1', label: 'View on books.com 1' },
  { url: 'books.com/2', label: 'View on books.com 2' },
  { url: 'books.com/2', label: 'View on books.com 3' },
];
const fourResource = [
  { url: 'books.com/1', label: 'View on books.com 1' },
  { url: 'books.com/2', label: 'View on books.com 2' },
  { url: 'books.com/2', label: 'View on books.com 3' },
  { url: 'books.com/4', label: 'View on books.com 4' },
];

describe('ElectronicResources', () => {
  it('should render one electronic resource', () => {
    const component = mount(
      <ElectronicResources electronicResources={oneResource} />,
    );
  ...
  it('should render three electronic resources', () => {
    const component = mount(
      <ElectronicResources electronicResources={threeResource} />,
    );
  ...
  it('should have id if id is passed', () => {
    const component = mount(
      <ElectronicResources electronicResources={threeResource} id='1234' />,
    );
  ...
  describe('show more/less button', () => {
    it('should render with more than 3 electronic resources', () => {
      const component = mount(
        <ElectronicResources electronicResources={fourResource} />,
      );
    ...
    it('should show all resources', () => {
      ...
      const component = mount(
        <ElectronicResources electronicResources={fourResource} isTestMode />,
      );
      const elements = component.find('ul').find('li');
      expect(elements).to.have.lengthOf(3);
