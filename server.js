...
app.use('/', (req, res, next) => {
  ...
  if (appConfig.legacyBaseUrl && req.path.indexOf(appConfig.legacyBaseUrl) === 0) {
    return res.redirect(302, req.path.replace(appConfig.legacyBaseUrl, appConfig.baseUrl));
  }
  return next();
});
